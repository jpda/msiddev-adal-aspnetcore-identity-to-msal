        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser
                {
                    ...
                    Email = model.Email,
                    UserExternalTenantId = info.ExternalIdentity.FindFirstValue("http://schemas.microsoft.com/identity/claims/tenantid"),
                    UserExternalObjectId = info.ExternalIdentity.FindFirstValue("http://schemas.microsoft.com/identity/claims/objectidentifer")
                };
